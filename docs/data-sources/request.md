...
- `grant_schema_definition_id` (String) Schema definition identifier used to validate grant payloads.
...
- `request_schema_definition_id` (String) Schema definition identifier used to validate request payloads.
